<%@ page title="" language="C#" masterpagefile="~/ls.master" autoeventwireup="true" inherits="tkctj, wrxuanke" %>
          ...
          <tr>
            <td width="46%" valign="middle"><table width="100%" border="0" cellspacing="0" cellpadding="0">
              <tr>
                ...
                <td width="95%" align="left"><span >你当前的位置</span>：[添加课程]</td>
              </tr>
            </table></td>
            <td width="54%">&nbsp;</td>
          </tr>
                ...
                <tr>
                    <td colspan="2" align="center">
                        ...
                        <asp:LinkButton ID="LinkButton1" runat="server" 
                            PostBackUrl="tkclist.aspx" CausesValidation="False">返回</asp:LinkButton>  <asp:ValidationSummary ID="ValidationSummary2" runat="server" 
