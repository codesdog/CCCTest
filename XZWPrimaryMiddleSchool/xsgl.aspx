<%@ page title="" language="C#" masterpagefile="~/MasterPage.master" autoeventwireup="true" inherits="xsgl, wrxuanke" %>
...
<tr class='Navigationtdbg'><td align=center>
  <table cellspacing="0" cellpadding="4" border="1" style="border-color:#B5D6E6;font-size:9pt;width:98%;border-collapse:collapse;" >
  <tr>
    <td align="center" >登陆名</td>
  ...
  <tr>
    ...
    <td align="center" >
     ...
     <td align="center" >
         ...
         <asp:Button ID="Button4" runat="server" Text="增加" onclick="Button4_Click" />
...
<RowStyle HorizontalAlign="Center"></RowStyle>
                ...
                <EditItemTemplate>
                    ...
                    <asp:TemplateField HeaderText="所选课程">
                        <ItemTemplate>
                            <asp:GridView ID="GridView1" runat="server" AutoGenerateColumns="False" 
                                ...
                                <RowStyle BorderStyle="None" BorderWidth="0px" Height="20px" />
                            </asp:GridView>
                        </ItemTemplate>
                    </asp:TemplateField>
