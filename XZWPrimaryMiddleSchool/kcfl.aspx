<%@ page title="" language="C#" masterpagefile="~/MasterPage.master" autoeventwireup="true" inherits="kcfl, wrxuanke" %>
...
<RowStyle HorizontalAlign="Center"></RowStyle>
                ...
                <Columns>
                    <asp:BoundField DataField="kcflid" HeaderText="课程分类序号" />
                    <asp:BoundField DataField="kcfl" HeaderText="课程分类名称" />
  ...
  <tr>
    ...
    <td>
     课程名称 <asp:TextBox ID="TextBox2" runat="server" Width="93"></asp:TextBox>
    </td>
    <td>
