<%@ page title="" language="C#" masterpagefile="~/xs.master" autoeventwireup="true" inherits="xsxgmm, wrxuanke" %>
                ...
                <tr>
                    <td colspan="2" align="center">
                        ...
                        <asp:LinkButton ID="LinkButton1" runat="server" 
                            PostBackUrl="xsindex.aspx" CausesValidation="False">返回</asp:LinkButton>  <asp:ValidationSummary ID="ValidationSummary2" runat="server" 
