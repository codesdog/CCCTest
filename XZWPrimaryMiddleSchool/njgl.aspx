<%@ page title="" language="C#" masterpagefile="~/MasterPage.master" autoeventwireup="true" inherits="njgl, wrxuanke" %>
...
<RowStyle HorizontalAlign="Center"></RowStyle>
                ...
                <Columns>
                    <asp:BoundField DataField="kcflid" HeaderText="年级序号" />
                    <asp:BoundField DataField="kcfl" HeaderText="年级名称" />
  ...
  <tr>
    ...
    <td>
        年级名称 <asp:TextBox ID="TextBox2" runat="server" Width="93"></asp:TextBox>
    </td>
    <td>
