...
<body style="text-align: center">
    ...
    <table style="width: 400px; height:247px; font-size: 9pt;" border="0" cellpadding="0" cellspacing="0" align="center"  background ="../images/logo.jpg" >
    <tr>
    <td style="width: 455px; height: 255px">
    <br />
     <br />
      <br />
       <br />
    ...
    <table style="width: 256px; height:86px; font-size: 9pt;" border="0" cellpadding="0" cellspacing="0" align="center" >
            ...
            <tr style="color: #000000" valign =top >
                ...
                <td style="width: 51px" valign =top >
                    &nbsp; 
                    <asp:Label ID="labCode" runat="server"  BackColor="SeaShell" Width="57px">8888</asp:Label></td>
            </tr>
            <tr>
