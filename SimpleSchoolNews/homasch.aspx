<%@ Page Language="C#" MasterPageFile="~/MasterPage.master" AutoEventWireup="true" CodeFile="homasch.aspx.cs" Inherits="homasch" Title="盱眙县第二中学" %>
                              ...
                              &nbsp<table border="0" style=" font-size :9pt; width: 100%; height: 100%;" cellspacing="0"  cellpadding =0 >
                                  <tr>
                                      <td style="width: 90px; height: 20px;">
                                       ...
                                       <td colspan="2" >
                                          <asp:LinkButton ID="lbtnTitle4" runat="server" CommandName="select" CausesValidation="False"><%# DataBinder.Eval(Container.DataItem,"title") %></asp:LinkButton>
                                       </td>
                                   </tr>
                                </table>
                         </ItemTemplate>
