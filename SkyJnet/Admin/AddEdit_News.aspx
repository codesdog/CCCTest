<%@ Page Language="C#" AutoEventWireup="true" CodeFile="AddEdit_News.aspx.cs" Inherits="Web.Admin.AddEdit_News" %>
...
<HTML>
	...
	<body>
		<form id="Form1" name="Form1" method="post" runat="server">
			...
			<br>
			<table class="tableBorder" id="table2" height="400" cellSpacing="1" cellPadding="3" align="center"	border="0">
				<tr>
					<th  id="tabletitlelink" style="FONT-WEIGHT: bold; FONT-SIZE: 12px; BACKGROUND-IMAGE: url(images/admin_bg_1.gif); COLOR: white; BACKGROUND-COLOR: #4455aa; "
						...
						<p align="center">
                            <asp:Label ID="lbl_title" Text="添加新闻" runat="server" /></p>
					</th>
				</tr>
				<tr>
					<td class="Forumrow" style="HEIGHT: 26px" >标题：<asp:textbox id="tb_title" runat="server" Width="307px"></asp:textbox></td>
				</tr>
				<tr>
					<td class="Forumrow" style="HEIGHT: 27px"  >
					<table border="0" ><tr>
					
					<td>类型：</td><td valign="middle"><asp:RadioButtonList ID="rb_NewsType" runat="server" RepeatColumns="2" Width="250" BorderStyle="None">
					<asp:ListItem Value="1" Text="公司新闻" Selected="True"></asp:ListItem>
					<asp:ListItem Value="2" Text="行业动态"></asp:ListItem>
					</asp:RadioButtonList></td>&nbsp;<td><asp:CheckBox ID="ckb_haspic" runat="server" Text="是否图片新闻" /></td>
					</tr></table>
					</td>
				</tr>
			    <tr>
					<th   id="Th3" style="FONT-WEIGHT: bold; FONT-SIZE: 12px; BACKGROUND-IMAGE: url(images/admin_bg_1.gif); COLOR: white; BACKGROUND-COLOR: #4455aa"
						...
						<b>新闻内容<a id="Set5" name="Set5"></a></b></th>
				</tr>
				<tr>
					
					<td  width="100%" class="Forumrow"><FONT face="宋体">
							<FTB:FreeTextBox ID="ftb_News" runat="server" ButtonPath="images/ftb/office2003/" Width="100%"
