<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="linkcategorylist.aspx.cs" Inherits="QiZhanBang.Web.backend.linkcategorylist" %>
...
<h3 class="boxtitle">后台管理 &gt;&gt; 链接分类管理</h3>
<table height="0" border="0" cellpadding="0" cellspacing="1" class="tabBgColor">
<tr align="center">
  <td height="25" background="Images/Top.gif"></td>
</tr>
</table>
  <asp:DataGrid runat="server" ID="dgLinkCategoryCategoryList" AutoGenerateColumns="false" 
        ...
        oncancelcommand="dgLinkCategoryCategoryList_CancelCommand" 
        oneditcommand="dgLinkCategoryCategoryList_EditCommand" 
        onitemcommand="dgLinkCategoryCategoryList_ItemCommand" 
        onitemcreated="dgLinkCategoryCategoryList_ItemCreated" 
        onupdatecommand="dgLinkCategoryCategoryList_UpdateCommand">
     <Columns>
        ...
        <asp:TemplateColumn HeaderText="链接类型" ItemStyle-Height="33" ItemStyle-HorizontalAlign="Center">
           <ItemTemplate>
              image
           </ItemTemplate>
           <FooterTemplate>
        ...
        <asp:TemplateColumn HeaderText="附加管理" ItemStyle-Height="33" ItemStyle-HorizontalAlign="Center">
           <ItemTemplate>
              <a href="linklist.aspx?categoryid=<%# DataBinder.Eval(Container.DataItem, "categoryid")%>">链接管理</a>
           </ItemTemplate>
        </asp:TemplateColumn>
