<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="productlist.aspx.cs" Inherits="QiZhanBang.Web.backend.productlist" %>
...
<tr>
  <td height="25" background="Images/Top.gif"><a class="hand" href="productedit.aspx?action=add&channelid=<%= ChannelId %>">添加产品</a></td>
</tr>
</table>
...
<FooterStyle HorizontalAlign="Center" BackColor="White" Height="33px"></FooterStyle>
     ...
     <Columns>
        ...
        <asp:TemplateColumn HeaderText="操作" ItemStyle-HorizontalAlign="Center">
             <ItemTemplate>
                <a href='productedit.aspx?action=edit&productid=<%# DataBinder.Eval(Container.DataItem, "productid")%>&channelid=<%# DataBinder.Eval(Container.DataItem, "channelid")%>'>编辑</a>
