<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="linklist.aspx.cs" Inherits="QiZhanBang.Web.backend.linklist" %>
...
<tr align="center">
  <td height="25" background="Images/Top.gif"><a href="linkedit.aspx?action=add&categoryid=<%= categoryid %>">添加链接</a></td>
</tr>
</table>
...
<ItemStyle HorizontalAlign="Center" Height="33px"></ItemStyle>
        ...
        <asp:TemplateColumn HeaderText="链接名称" ItemStyle-Height="33" ItemStyle-HorizontalAlign="Center">
           <ItemTemplate>
...
<ItemStyle HorizontalAlign="Center" Height="33px"></ItemStyle>
        ...
        <asp:TemplateColumn HeaderText="图片" ItemStyle-Height="33" HeaderStyle-Width="150" ItemStyle-HorizontalAlign="Center">
           <ItemTemplate>
              <img src="<%# DataBinder.Eval(Container.DataItem, "includepic")%>" width="150" height="50" />
           </ItemTemplate>
...
<ItemStyle HorizontalAlign="Center" Height="33px"></ItemStyle>
        ...
        <asp:TemplateColumn HeaderText="操作" ItemStyle-HorizontalAlign="Center">
             <ItemTemplate>
                <a href='linkedit.aspx?action=edit&linkid=<%# DataBinder.Eval(Container.DataItem, "linkid")%>&categoryid=<%# DataBinder.Eval(Container.DataItem, "categoryid")%>'>
                 编辑</a>
