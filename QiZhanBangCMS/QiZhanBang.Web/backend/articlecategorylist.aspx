<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="articlecategorylist.aspx.cs" Inherits="QiZhanBang.Web.backend.articlecategorylist" %>
...
<tr align="center">
  ...
  <asp:DataGrid runat="server" ID="dgArticleCategoryList" AutoGenerateColumns="false" 
        ...
        oncancelcommand="dgArticleCategoryList_CancelCommand" 
        oneditcommand="dgArticleCategoryList_EditCommand" 
        onitemcommand="dgArticleCategoryList_ItemCommand" 
        onitemcreated="dgArticleCategoryList_ItemCreated" 
        onupdatecommand="dgArticleCategoryList_UpdateCommand">
     <Columns>
