<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="help.aspx.cs" Inherits="QiZhanBang.Web.help" %>
...
<%
    string pagerhtml = "";
    System.Data.DataTable newlist = getarticle(4,11,8,"help.aspx?p={0}",out pagerhtml);
    foreach (System.Data.DataRow nRow in newlist.Rows)
    { %>
<li><a href="helpshow.aspx?articleid=<%= nRow["articleid"]%>"><%= nRow["title"]%></a></li>
<%} %>
</ul>
<div class="gopage">
   <%= pagerhtml %>
