...
namespace QiZhanBang.Core.Factory
{
    ...
    {
        public static void Add(ArticleCategory info)
        {
            string sql = @"INSERT INTO ecms_articlecategory ( 
                            [channelid] ,
                            [channelname] ,
                            [categoryname] ,
                            [categoryname1] ,
        ...
        {
            string sql = "delete from ecms_articlecategory where categoryid = " + categoryid;
            OleDbHelper.ExecuteNonQuery(sql);
        }

        public static void Update(ArticleCategory info)
        {
        ...
        public static ArticleCategory Get(int categoryid)
        {
            string sql = "select * from ecms_articlecategory where categoryid=" + categoryid ;
            ArticleCategory info = null;
        ...
        {
            string sql = "select * from ecms_articlecategory where channelid=" + channelid + " order by orderid asc";
