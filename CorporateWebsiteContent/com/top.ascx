<%@ Control Language="C#" AutoEventWireup="true" CodeFile="top.ascx.cs" Inherits="com_top" %>
<style type="text/css">
    .style1
    {
        height: 36px;
...
<table width="980" height="90" border="0" align="center" cellpadding="0" cellspacing="0"
    ...
    <tr>
        <td width="980" class="style1" style="text-align: right">
            <a onclick="this.style.behavior='url(#default#homepage)';this.setHomePage(');" href="#">
                设为首页</a>|<a href='#' onclick='window.external.AddFavorite(&quot;http://www.gszckt.com/&quot;,&quot;甘肃中辰机电安装工程公司&quot;)'>加入收藏</a>|<a
                    href="/Search.aspx" style="text-align: right">站内搜索|中文版|</a>|<a href="english/index.aspx">英文版</a>
        </td>
    </tr>
    <tr>
        <td width="632">
...
<table width="980" height="40" border="0" align="center" cellpadding="0" cellspacing="0"
    style="background-image: url(images/bg-nav.jpg)">
    <tr>
        <td>
            <div id="nav">
                <ul style="text-align: left">
                    <li style="font-size: 14px; color: #fff; float: left; text-align: left;">今天是:<script
      ...
      "星期六");
       ...
       "</font>"); 
                    ...
                    <li><a href="AllProducts.aspx">产品展示</a></li>
                    <!--  <li ><a href ="Products.aspx">客户案例</a></li>-->
                    <li><a href="Resume.aspx">招贤纳士</a></li>
