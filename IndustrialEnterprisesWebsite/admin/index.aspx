<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="index.aspx.cs" Inherits="Webwangzhan.admin.index" %>

<!DOCTYPE html PUBLIC "-//W3C//DTD XHTML 1.0 Transitional//EN" "http://www.w3.org/TR/xhtml1/DTD/xhtml1-transitional.dtd">

<html xmlns="http://www.w3.org/1999/xhtml">
<head runat="server">
    <title>超级管理员后台管理系统</title>
                ...
                <Items>
                    <x:ContentPanel ShowBorder="false" CssClass="jumbotron" ShowHeader="false" ID="ContentPanel1"
                        ...
                        <div class="title">
                            ...
                            &nbsp;<a href="#" style="color:#fff;">FineUI在线示例</a>
                        </div>
                    </x:ContentPanel>
                </Items>
            </x:Region>
                                ...
                                <Toolbars>
                                    <x:Toolbar runat="server">
                                        <Items>
                                            ...
                                            <x:Button ID="btnGotoOpenSourceSite" Icon="TabGo" Text="下载示例" OnClientClick="window.open('http://fineui.codeplex.com/');"
                                                EnablePostBack="false" runat="server">
                                            </x:Button>
                                            <x:ToolbarSeparator ID="ToolbarSeparator1" runat="server">
                                            </x:ToolbarSeparator>
                                            <x:Button ID="Button1" Icon="TabGo" Text="论坛交流" OnClientClick="window.open('http://fineui.com/bbs/');"
                                                EnablePostBack="false" runat="server">
                                            </x:Button>
                                        </Items>
                                    </x:Toolbar>
