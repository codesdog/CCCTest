<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="addgdclass.aspx.cs" Inherits="Webwangzhan.admin.goods.addgdclass" %>
...
<body>
  ...
  <x:Window ID="Window1" runat="server" Title="类别添加" IsModal="false" EnableClose="false"
