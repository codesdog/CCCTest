<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="edigood.aspx.cs" Inherits="Webwangzhan.admin.goods.edigood" %>
...
<table width="1000" border="0" cellspacing="0" cellpadding="0" class="free_table">
  ...
  <td class="border-bottom" >   
      <asp:Button ID="tijiao" runat="server" Text="确认，修改" class="common_btn" 
