...
namespace DB
{
    ...
    public abstract class DbHelperOleDb
    {
        ...
        //public static string connectionString = "Provider=Microsoft.Jet.OLEDB.4.0;Data Source=";     		//conectionstring
        public static string connectionString = "Provider=Microsoft.Jet.OLEDB.4.0;Data Source=" + AppDomain.CurrentDomain.BaseDirectory + "cj.mdb" +"; Jet OLEDB:Database Password=xjg123;";
