...
<body>
<div align="center" class="Noprint"><a href="javascript:window.print()">[打印]</a></div>
...
dim sql7,rs7,username,truename,province,city,telphone1,telphone2,fax,mobile,address,postno,email
	sql7="select * from x_view_bill where username='"&session("username")&"' and id="&request.QueryString("id")&""
...
<div align="right">特别说明：</div></TD>
		...
		set rs4=nothing
		    ...
		    <table width="100%" border="0" cellpadding="0" cellspacing="0">
              <tr> 
                <td colspan="2" height="35" width="65%"><b>
