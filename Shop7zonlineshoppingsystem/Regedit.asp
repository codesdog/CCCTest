...
<TR bgColor=#ffffff> 
                          ...
                          <TD width="79%">
                            <textarea name="textarea" cols="68" rows="8" readonly>请你先阅读我们的注册声明，如果同意，请进行用户注册。 
...
15．法律
　　<%=application("sitename")%>网站信息服务条款要与中华人民共和国的法律解释一致。用户和<%=application("sitename")%>网站一致同意所在地有管辖权的法院管辖。如发生本网站服务条款与中华人民共和国法律相抵触时，则这些条款将完全按法律规定重新解释，而其它条款则依旧保持对用户的约束力。 </textarea></TD>
                          </TR>
					</table>
