...
%>
	<FORM name="theForm" onSubmit="return Juge()" action="g_post.asp" method="post">
      ...
      src="pic/icon18.gif" width=15></TD>
            ...
            <TR> 
            <TR> 
              <TD align=left colSpan=2> <FONT class=f14 color=#df0024><b>注意事项</b></FONT><BR>
                禁止发表下列信息，一切发表，仅代表作者本人立场． <BR>
                (一)反对宪法所确定的基本原则的； <BR>
                (二)危害国家安全，泄露国家秘密，破坏国家统一的； <BR>
                (三)损害国家荣誉和利益的； <BR>
                (四)煽动民族仇恨、民族歧视，破坏民族团结的； <BR>
                (五)破坏国家宗教政策，宣扬邪教和封建迷信的； <BR>
                (六)散布谣言，扰乱社会秩序，破坏社会稳定的； <BR>
                (七)散布淫秽、色情、赌博、暴力、犯罪的； <BR>
                (八)侮辱或者诽谤他人，侵害他人合法权益的；</TD>
            </TR>
          </TBODY>
        </TABLE>
      </FORM>
