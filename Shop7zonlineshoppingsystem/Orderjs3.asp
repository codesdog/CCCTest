...
<form name="payform" method="post" action="pay/index.asp">
                <tr> 
                  <td height="40" style="font-size:14px;line-height:180%;">&nbsp;&nbsp; 
                    <input type="button" name="Submit" value="点击通过“支付宝”完成网上支付" class="input2" style="width:240px;height:24px;"  onclick="javascript:alert('免费版程序不支持订单后期支付功能(仅支持下完订单后立即支付)，正式版本无限制，官网：Http://www.Shop7z.com')" > 
                  </td>
                </tr>
              </form>			<%
					end if 			
