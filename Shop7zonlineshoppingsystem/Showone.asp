...
%>
            <TABLE class=text cellSpacing=0 cellPadding=0 width="96%" align=center  border=0>
              <TBODY>
                <TR> 
                  <TD width="91%" height=32 vAlign=bottom><IMG height=19 src="images/dian04.gif" width=10 align=absMiddle> <STRONG>&nbsp;<FONT color=#ff6600 style='font-size:14px;'><%=c_title%></FONT></STRONG></TD>
                  <TD width="9%" vAlign=bottom>&nbsp;</TD>
                </TR>
                <TR> 
                  <TD height=25 colspan="2" vAlign=top> <DIV align=left><IMG height=25 src="images/line.gif" width=592></DIV></TD>
                </TR>
                <TR> 
