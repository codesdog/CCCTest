					...
					<TBODY>
                      <TR align=left> 
                        <TD height="95" valign="top" style="PADDING-LEFT: 8px;PADDING-top: 22px; line-height:180%;"> 
                          商品类别：<B><%=kindname%></B><br>
						  商品名称：<font style="font-size:14px;color:#CC6600"><%=productname%></font><br>
                          商品编号：<b><%=model%></b> <br>
                  ...
                  style="BORDER-RIGHT: #999999 1px dotted; BORDER-TOP: #999999 1px dotted; BORDER-LEFT: #999999 1px dotted; BORDER-BOTTOM: #999999 1px dotted" width=300 noShade SIZE=1> 
                      ...
                      <TR align=left> 
                        <TD height="50" vAlign=center style="PADDING-LEFT: 8px; COLOR: #666666; "> 
                          <font style="width:80px;">市场价：</font><FONT class='oldprice'><del>￥<%=price1%></del></FONT> <BR>
						  <FONT color=#ff0000 style="width:80px;"><%=session("customkindname")%>价：</font><font class='nowprice'>￥<%=price2%></font></TD>
                      </TR>
                        ...
                        <TD  valign="top">
							 <TABLE cellSpacing=0 cellPadding=0 width="740" border=0 bgcolor="#eeeeee">
								  <TR style="text-align:center;"> 
									<TD height=27 width=100 bgcolor="#ffffff" id=but1  style="border-right:1px solid #cccccc"><A HREF="javascript:void(0)" onClick="OnClickColor('1');"><b>商品详细</b></a></TD>
