...
<table width="750" border="0" align="left" cellpadding="0" cellspacing="0" id="tabcss">
  <tr bgcolor="#BFDFFF">
      <td colspan="2"><b>商品资料修改</b></td>
    </tr>
    <tr> 
      <td >上市时间： <input name="addtime" type="text" id="addtime" value='<%=addtime%>'></td>
      <td>种类：　　
...
<input type="text" name="model" value="<%=model%>" size="32">      </td>
    ...
    <tr> 
      ...
      <td>会员价：　 
        <input name="price2" type="text" id="price2" value="<%=price2%>">(普通会员)<input type="button" name="Buttonprice" value="全部会员价相同" title="方便录入其他会员价。点击这里后其他级别价格和普通会员价一样。" onClick="myprice()" style="background-color:#cccccc;width:90px;"></td>
    </tr>
    <tr> 
      <td >铜级价：　 
	...
	<tr><td><font style="position:absolute;top:-11px; width: 152px; height: 0px; left: 0px; ">品牌：</font><select name="selectmenu" style="position:absolute;top:-11px; width: 152px; height: 0px; left: 45px; clip: rect(0 180 110 133) "  onChange="theForm.pipai.value=this.options[this.selectedIndex].value">
		<%
    ...
    <tr>
      <td>单件重量： 
		...
		<img src='../images/helpmemo.gif' alt="如果运费是按重量计算的，请填写商品的重量，<br>如果运费是按件计算的，填写重量或填写0。<br>具体请看“配送计费”-“选择配送计费方式”。">		</td>
      <td>库存数量： 
...
<tr><td colspan=2>
    ...
    <tr> 
      <td width="65%"> 
		...
		&nbsp;		</td>
	    <td width="35%" rowspan="3"><a href='' id='showpic' target='_blank'><img name='photo_2' height="140" width="140" border="0" src="" alt="鼠标放在左边黄色小图,图片在这预览,点击可查看原图" title="图片预览区域。点击可查看原图。"></a></td>
    </tr>
    <tr>
      <td height="22">
...
<textarea id="disc" name="disc" cols="100" rows="8" style="width:725px;height:400px;visibility:hidden;"><%=htmlspecialchars(disc)%></textarea>
    ...
    <tr><td height="40" colspan="2"><div align="center">
		  ...
		  <input type="Submit" name="Submit" value="  修  改  " style="background-color:#cccccc;width:90px; height:25px;"></div></td>
    </tr>
