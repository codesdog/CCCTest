...
response.write "<script language=JavaScript>" & "window.opener.document.theForm."&picsize&".value ='"&FileName&"';" & "window.close();" & "window.opener.document.theForm."&picsize&".style.background='#f5f5f5';" & "</script>"
