...
<form name="theForm" method="post" action="getpassword2.asp" onSubmit="return Juge(this)">  
  <table width="80%" align="center" border=1 cellspacing=0 cellpadding=1 bordercolorlight=#5BD77D bordercolordark=#ffffff>
    <tr>
                    <td class=titlehead height=24>取回密码：<%session("getpsw")="1"%></td>
    </tr>
  </table>
                <table width="80%" height="156" border="0" align="center" cellpadding="0" cellspacing="0" class="tableborder">
                  <tr> 
...
<div align="right">请输入您的用户名：&nbsp;</div></td> 
                    <td width="71%"> 
...
<div align="right">验证码：&nbsp;</div></td>
                  ...
                  <tr> 
                    <td height="32" colspan="2"> 　说明：如果通过“取回密码”不能成功取回密码，请致电<%=application("sitename")%>网服务中心。</td>
                  </tr>
                </table>
              </form>
            </TD>
