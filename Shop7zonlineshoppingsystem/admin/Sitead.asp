...
<table width="97%" border="0" align="center" cellpadding="0" cellspacing="0" id="tabcss">
  ...
  <form name="form1" method="post" action="sitead.asp">
    ...
    <tr bgcolor='#Ffffff' onMouseOver="this.style.background='#FFE4CA';" onMouseOut="this.style.background='#ffffff';">
      ...
      <td>上传图片
        <input name='cuxpicurl' type=text id="cuxpicurl" value="<%=cuxpicurl%>" size="40">
          <input type="button" name="Button2" value="选图片" onClick="window.open('../images/uploadpic.asp?size=cuxpicurl','','width=410,height=350,top=120,left=281')">
        (550 X 约125) <img src='../images/helpmemo.gif' alt="图片预览：<br><img src='../<%=cuxpicurl%>'>"></td>
    </tr>
    <tr bgcolor='#Ffffff' onMouseOver="this.style.background='#FFE4CA';" onMouseOut="this.style.background='#ffffff';">
      <td height='23' align='right'>&nbsp;</td>
      <td>链接地址
        <input name='cuxpiclink' type=text id="cuxpiclink" value="<%=cuxpiclink%>" size="40">
          <strong>必选</strong></td>
    </tr>
